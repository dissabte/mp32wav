// LittleBigEndian.h by k06a (k06aaa@gmail.com, http://k06a.blogspot.com/)
...
struct LittleEndian
{
	...
	static const T fromBuffer(unsigned char* buffer)
	{
		return static_cast<const T>(*reinterpret_cast<LittleEndian<T>*>(buffer));
	}
};
#pragma pack(pop)
...
struct BigEndian
{
	...
	static const T fromBuffer(unsigned char* buffer)
	{
		return static_cast<const T>(*reinterpret_cast<BigEndian<T>*>(buffer));
	}
};
#pragma pack(pop)
